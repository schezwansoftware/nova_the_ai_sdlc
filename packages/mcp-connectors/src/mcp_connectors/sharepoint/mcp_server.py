"""Standalone SharePoint MCP server -- the `sharepoint-mcp`
...
from mcp_connectors.sharepoint.client import SharePointClient
from mcp_connectors.sharepoint.config import SharePointConnectorConfig, load_config

SERVER_NAME = "sharepoint-mcp"
